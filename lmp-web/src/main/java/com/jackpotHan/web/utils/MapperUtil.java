package com.jackpotHan.web.utils;

import com.alibaba.fastjson.JSON;
import com.jackpotHan.base.BaseCode;
import com.jackpotHan.base.BaseException;
...
//                        Object fieldValue = f.get(t);
                        ...
                        String logic = "";
                        if (BaseUtil.isNotEmpty(fieldValue)) {
...
/*
                        ...
                        } else if (!ObjectUtils.equals(fieldValue, null) && BaseUtil.isNotEmpty(logic)) {
                            switch (logic) {
                                case ">":
                    ...
                    throw new BaseException(BaseCode.ERR.getCode(), "setExampleCriteria exception.");
                }
            }
        }
    }

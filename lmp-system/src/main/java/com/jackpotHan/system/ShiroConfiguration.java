...
import com.jackpotHan.system.shiro.MyShiroRealm;
...
public class ShiroConfiguration {
    ...
    public ModularRealmAuthorizer getModularRealmAuthorizer() {
        ...
        modularRealmAuthorizer.setRealms(Lists.newArrayList(getMyShiroRealm()));
    ...
    public ModularRealmAuthenticator getModularRealmAuthenticator() {
        ...
        modularRealmAuthenticator.setRealms(Lists.newArrayList(getMyShiroRealm()));
